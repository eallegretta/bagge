...
<asp:RequiredFieldValidator ID="_calendarReqVal" Visible="false" runat="server" Display="Dynamic" ControlToValidate="_calendar"></asp:RequiredFieldValidator>
<asp:CustomValidator id="_invalidDateVal" ValidateEmptyText="false" Display="Dynamic" ClientValidationFunction="ValidateDateCalendar" runat="server"></asp:CustomValidator>
<asp:CustomValidator id="_calendarCompare" ValidateEmptyText="false" Display="Dynamic" ClientValidationFunction="ValidateCompareCalendar" runat="server"></asp:CustomValidator>
