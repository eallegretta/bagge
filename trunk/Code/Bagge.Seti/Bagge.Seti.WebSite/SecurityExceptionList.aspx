<%@ Page Title="" Language="C#" MasterPageFile="~/List.Master" AutoEventWireup="true" CodeBehind="SecurityExceptionList.aspx.cs" Inherits="Bagge.Seti.WebSite.SecurityExceptionList" meta:resourcekey="Page" %>
