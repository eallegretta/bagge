...
<asp:Content ID="_filters" ContentPlaceHolderID="_filters" runat="server">
	...
	<seti:Calendar ID="_dateFrom" runat="server" CompareToCalendarId="_dateTo" CompareOperator="LessThanEqual" CompareErrorMessage="<%$ Resources:WebSite, DateFromMustBeLowerThanOrEqualToDateToErrorMessage%>" />
	&nbsp;&nbsp;&nbsp;
	<asp:Literal id="_dateToLiteral" runat="server" meta:resourcekey="FilterDateToLiteral" ></asp:Literal>
	<seti:Calendar ID="_dateTo" runat="server" CompareToCalendarId="_dateFrom" CompareOperator="GreaterThanEqual" CompareErrorMessage="<%$ Resources:WebSite, DateToMustBeGreaterThanOrEqualToDateFromErrorMessage%>" />
	&nbsp;&nbsp;&nbsp;
