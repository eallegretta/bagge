...
<asp:Content ID="_filters" ContentPlaceHolderID="_filters" runat="server">
	<table>
		...
		<tr>
			...
			<th><asp:Literal ID="_technicianNameLiteral" runat="server" meta:resourcekey="TechnicianNameLiteral"></asp:Literal></th>
			<td><asp:TextBox ID="_technicianName" runat="server"></asp:TextBox></td>
			<th><asp:Literal ID="_adminNameLiteral" runat="server" meta:resourcekey="AdminNameLiteral"></asp:Literal></th>
