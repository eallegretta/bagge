...
<table>
	<tr>
		...
		<td rowspan="2">
		<asp:Button ID="_add" runat="server" onclick="_add_Click" 
...
<ajax:AutoCompleteExtender ID="_nameExt" runat="server" TargetControlID="_name" ServiceMethod="GetItems"></ajax:AutoCompleteExtender>
</asp:PlaceHolder>
